...
//Validar URL por ID valido (Si el id que se envía por mediod e la url no es valido redirige denuevo al index de admin.)
$id = $_GET['id'];
...
//Consulta para obtener datos propiedad
...
<main class="contenedor seccion">
    ...
    <form class="formulario" method="POST" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <img src="/imagenes/<?php echo $imagenPropiedad ?>" alt="imgPropiedad" class="imagen-small">
