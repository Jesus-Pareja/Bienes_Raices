...
* Added `removeOffCanvasPaths` plugin to remove elements outside of the viewbox (by @Joshyhtml).
...
* Fixed arcs transforming with different signed `scale` parameters (by @Joshyhtml).
